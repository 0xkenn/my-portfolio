    ...
    <nav className="navbar bg-base-100">
      ...
      <div className="navbar-start">
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            ...
            <li><Link to='/projects'>Projects</Link></li>  {/* Corrected the nested <li> */}
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1">
          <li><Link to='/'>About</Link></li>  {/* Use Link for consistency */}
          <li><Link to='/projects'>Projects</Link></li>  {/* Use Link for consistency */}
          <li><Link to='/contact'>Contact</Link></li>  {/* Use Link for consistency */}
        </ul>
      </div>
